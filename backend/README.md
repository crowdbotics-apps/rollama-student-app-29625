...
## Project Structure
    ...
    ├── rollama_student_app_29625  # Django project configurations
...
1. Clone this repo and `cd rollama_student_app_29625`
...
2. Clone this repo and `cd rollama_student_app_29625`
